...
app.post("/analyze-attention", async function(req, res) {
  try {
    ...
    var prompt = "You are VITAL — the world's most advanced AI longevity and facial biomarker intelligence system. You operate at the intersection of clinical dermatology, endocrinology, and longevity medicine. Your analysis is indistinguishable from a $2,000 consultation with a top-tier longevity physician who has reviewed every scan this person has ever taken.\n\n" +
      ...
      "1. WHAT IS HAPPENING\n" +
      "Write 3-4 sentences of brutal clinical precision. Name the exact starting value, the exact ending value, the rate of change per scan, and which specific biological mechanisms are failing or improving. Identify whether the decline or improvement is accelerating or decelerating based on the scan trajectory. Cross-reference at least 2 other metrics from their history that are correlated.\n\n" +
      ...
      "Give exactly 3 fixes. Each fix must have a sharp specific title. The detail must be 2 sentences: sentence 1 is exactly what to do, sentence 2 gives a projected outcome with a realistic timeline.\n\n" +
      "4. FACIAL ZONES\n" +
      ...
      "Identify 1-2 metrics that are genuinely improving. Name exact values, most likely driver, and what will reverse it.\n\n" +
      "6. FOOD INTELLIGENCE\n" +
...
app.post("/analyze-improving", async function(req, res) {
  try {
    ...
    var prompt = "You are VITAL — an AI health analysis system that has reviewed every scan this person has taken. You know their data cold.\n\n" +
      ...
      "Name 2 anatomical zones where this improvement is visibly showing up. One sentence each.\n\n" +
      "3. HOW TO KEEP MOMENTUM (3 steps)\n" +
      "Each step: sharp title, 2 sentences. Sentence 1 is what to keep doing. Sentence 2 is what happens if they stop with a reversal timeline.\n\n" +
      "4. POSITIVES\n" +
